...
public class mcs_OrderCreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcs_order_create);
        getSupportActionBar().setTitle("mcs_Order Create");
			...
			public boolean onTouch(View v, MotionEvent event) {
				switch (event.getAction()) {
					case MotionEvent.ACTION_DOWN:
				        ...
				        datePickerDialog = new DatePickerDialog(mcs_OrderCreateActivity.this,
