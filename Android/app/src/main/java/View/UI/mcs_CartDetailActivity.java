...
public class mcs_CartDetailActivity extends AppCompatActivity {
	TextView tvCartId;
	TextView tvUserId;
	TextView tvStatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcs_cart_detail);
        getSupportActionBar().setTitle("mcs_Cart Detail");
