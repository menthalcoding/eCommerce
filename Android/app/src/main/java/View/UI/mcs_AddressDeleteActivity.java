...
public class mcs_AddressDeleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcs_address_delete);
        getSupportActionBar().setTitle("mcs_Address Delete");
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Deletemcs_Address(new Integer(tvAddressId.getText().toString()));
            }
        });
    ...
    private void Deletemcs_Address(Integer AddressId) {
        mcs_AddressCriteria criteria = new mcs_AddressCriteria();
		criteria.AddressId = AddressId;
        _mcs_AddressRepository.Delete(criteria);
