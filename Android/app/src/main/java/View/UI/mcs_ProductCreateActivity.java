...
public class mcs_ProductCreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcs_product_create);
        getSupportActionBar().setTitle("mcs_Product Create");
			...
			public boolean onTouch(View v, MotionEvent event) {
				switch (event.getAction()) {
					case MotionEvent.ACTION_DOWN:
				        ...
				        datePickerDialog = new DatePickerDialog(mcs_ProductCreateActivity.this,
