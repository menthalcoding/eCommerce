...
public class mcs_OrderDetailActivity extends AppCompatActivity {
	TextView tvOrderId;
	TextView tvUserId;
	TextView tvCartId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcs_order_detail);
        getSupportActionBar().setTitle("mcs_Order Detail");
