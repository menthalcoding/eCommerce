...
public class mcs_PaymentCreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcs_payment_create);
        getSupportActionBar().setTitle("mcs_Payment Create");
			...
			public boolean onTouch(View v, MotionEvent event) {
				switch (event.getAction()) {
					case MotionEvent.ACTION_DOWN:
				        ...
				        datePickerDialog = new DatePickerDialog(mcs_PaymentCreateActivity.this,
