...
public class mcs_CartItemEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcs_cartıtem_edit);
        getSupportActionBar().setTitle("mcs_CartItem Edit");
			...
			public boolean onTouch(View v, MotionEvent event) {
				switch (event.getAction()) {
					case MotionEvent.ACTION_DOWN:
				        ...
				        datePickerDialog = new DatePickerDialog(mcs_CartItemEditActivity.this,
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (IsValid()) {
					...
					model.setCartItemId(new Integer(tvCartItemId.getText().toString()));
    ...
    void Editmcs_CartItem(mcs_CartItemDto item) {
        if (item != null) {
            _mcs_CartItemRepository.Put(item);
