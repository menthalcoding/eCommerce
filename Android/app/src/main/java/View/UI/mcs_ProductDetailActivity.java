...
public class mcs_ProductDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcs_product_detail);
        getSupportActionBar().setTitle("mcs_Product Detail");
