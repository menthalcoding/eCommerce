...
public class mcs_ShippingDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcs_shipping_detail);
        getSupportActionBar().setTitle("mcs_Shipping Detail");
