...
public class mcs_AddressEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcs_address_edit);
        getSupportActionBar().setTitle("mcs_Address Edit");
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (IsValid()) {
					...
					model.setAddressId(new Integer(tvAddressId.getText().toString()));
    ...
    private void Getmcs_Address(Integer AddressId) {
        ...
        if (data != null) {
			...
			etGPS.setText(String.valueOf(data.getGPS()));
			etCountry.setText(String.valueOf(data.getCountry()));
			etCity.setText(String.valueOf(data.getCity()));
			etZipCode.setText(String.valueOf(data.getZipCode()));
			etCountryCode.setText(String.valueOf(data.getCountryCode()));
			etDetail.setText(String.valueOf(data.getDetail()));
			etPrimary.setText(String.valueOf(data.getPrimary()));
			etActive.setText(String.valueOf(data.getActive()));
        }
        else {
    ...
    void Editmcs_Address(mcs_AddressDto item) {
        if (item != null) {
            _mcs_AddressRepository.Put(item);
