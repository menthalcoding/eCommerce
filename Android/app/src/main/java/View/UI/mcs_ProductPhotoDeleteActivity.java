...
public class mcs_ProductPhotoDeleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcs_productphoto_delete);
        getSupportActionBar().setTitle("mcs_ProductPhoto Delete");
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Deletemcs_ProductPhoto(new String(tvProductPhotoId.getText().toString()));
            }
        });
    ...
    private void Deletemcs_ProductPhoto(String ProductPhotoId) {
        mcs_ProductPhotoCriteria criteria = new mcs_ProductPhotoCriteria();
		criteria.ProductPhotoId = ProductPhotoId;
        _mcs_ProductPhotoRepository.Delete(criteria);
